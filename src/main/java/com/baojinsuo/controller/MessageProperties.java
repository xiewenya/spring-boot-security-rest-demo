...
public class MessageProperties {
    ...
    private static String FILE_NAME = "/ValidationMessages.properties"; //文件名
    ...
    static {
        ...
        InputStream stream = MessageProperties.class.getResourceAsStream(FILE_NAME);
        if (stream == null) {
    ...
    public static void save() {
        try {
            URL url = MessageProperties.class.getResource(FILE_NAME);
