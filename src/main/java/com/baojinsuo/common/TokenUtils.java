...
public class TokenUtils {
  ...
  @Value("${baojinsuo.token.secret}")
  private String secret;

  @Value("${baojinsuo.token.expiration}")
  ...
  public Boolean validateToken(String token, UserDetails userDetails) {
    ...
    return (username.equals(user.getUsername()) &&
            ...
            !(this.isCreatedBeforeLastPasswordReset(created, SafeUtils.unixTime2Date(user.getCustomer().getLastPasswordReset()))));
  }
